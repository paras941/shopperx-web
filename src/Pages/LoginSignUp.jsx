...
export const LoginSignUp = () => {
  ...
  const { loginUser, showToast } = useContext(ShopContext);
    ...
    <div className='loginsignup'>
      <div className="loginsignup-container">
        ...
        <p className="loginsignup-subtitle">
          {mode === 'signup' ? 'Sign up to get started with your shopping' : 'Sign in to continue shopping'}
        </p>
        ...
        <p className="loginsignup-toggle">
          ...
          <span onClick={toggleMode}>{mode === 'signup' ? 'Sign In' : 'Sign Up'}</span>
        </p>
        {mode === 'signup' && (
